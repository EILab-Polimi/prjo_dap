...
/**
 * @DataProducer(
 *   id = "query_dap_articles",
 *   name = @Translation("Load DAP articles"),
 *   description = @Translation("Loads a list of DAP articles."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("Article DAP connection")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QueryDAPArticles extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
