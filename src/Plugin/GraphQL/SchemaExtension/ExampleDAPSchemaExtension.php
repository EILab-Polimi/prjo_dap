...
/**
 * @SchemaExtension(
 *   id = "dap_custom_composable_extension",
 *   name = "DAP custom composable extension",
 *   description = "A simple extension for DAP.",
 *   schema = "dap_custom_composable"
 * )
 */
class ExampleDAPSchemaExtension extends SdlSchemaExtensionPluginBase {
